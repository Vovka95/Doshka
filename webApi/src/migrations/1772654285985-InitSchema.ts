...
export class InitSchema1772654285985 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TYPE "public"."user_token_type_enum" AS ENUM('EMAIL_CONFIRM', 'PASSWORD_RESET')`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `CREATE INDEX "IDX_dddcdb2ee94efe1ad80e95fb37" ON "user_token" ("userId", "type") `,
        );
        await queryRunner.query(
            `CREATE UNIQUE INDEX "IDX_bc9d86dcccb78e70cb0cfd4b38" ON "user_token" ("type", "tokenHash") `,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `DROP INDEX "public"."IDX_bc9d86dcccb78e70cb0cfd4b38"`,
        );
        await queryRunner.query(
            `DROP INDEX "public"."IDX_dddcdb2ee94efe1ad80e95fb37"`,
        );
